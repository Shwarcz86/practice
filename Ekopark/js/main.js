$(document).ready(function() {
  ...
  if (window.matchMedia('(max-width: 1024px)').matches) { // аналог media-queries
    $('.map-page__body').wrap('<div class="container"></div>');
  }
  ...
  $('.tab').on('click', function(e) { 
    ...
    */
    $('.offers-slider__choise').slick('setPosition') //Инициализация табов
  });
  

  $('.offers-slider__choise').slick({
    slidesToShow: 3,
    slidesToScroll: 1,
    arrows: true,
    dots: true,
