    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    document.querySelector(".submenu-open") ? document.querySelector(".submenu-open").classList.remove("submenu-open") : null;
                }
            }));
        }
        ...
        function initSliders() {
            if (document.querySelector(".main-slider__slider")) new core(".main-slider__slider", {
                ...
                pagination: {
                    el: ".control-main-slider__dots",
                    clickable: true
                },
                on: {
                    init: function(swiper) {
                        const allSlides = document.querySelector(".fraction-control__all");
                        const allSlidesItems = document.querySelectorAll(".slide-main-slider:not(.swiper-slide-duplicate)");
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                if (subMenu) document.documentElement.classList.toggle("submenu-open"); else console.log("Нет такого подменю!");
                e.preventDefault();
            }
            if (targetElement.closest(".submenu__back")) {
                document.documentElement.classList.remove("submenu-open");
                document.querySelector("._submenu-open") ? document.querySelector(".submenu-open").classList.remove("submenu-open") : null;
            }
        }
        window["FLS"] = true;
        isWebp();
